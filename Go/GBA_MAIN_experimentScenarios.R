...
nrounds_list <- c(10, 25, 50, 100) # , 1000)
...
# cat("Scenario 1 training contains: ", nrow(training_data_scenario_one), " Scenario 2 training contains: ", nrow(training_data_scenario_two), " Scenario 3 training contains: ", nrow(training_data_scenario_three), "\n")
# cat("Scenario 1 prediction contains: ", nrow(prediction_data_scenario_one), " Scenario 2 prediction contains: ", nrow(prediction_data_scenario_two), " Scenario 3 prediction contains: ", nrow(prediction_data_scenario_three), "\n")
...
csv_file_path <- "D:/Users/Chris/Documents/Studium Extended/Semester 7/Bachelorarbeit/R/statistic_table.csv"
